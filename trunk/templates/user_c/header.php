...
<div id="url" style="display: none;"><?=$this->data['url']?></div>
<div id="meid" style="display: none;"><?=$this->data['meid']?></div>
<div id="homeinfo" style="display: none;"><?=homeinfo?></div>
<div id="landingpage" style="display: none;"><?=$this->data['landingpage']?></div>
<div id="lat" style="display: none;"><?=$this->data['lat']?></div>
<div id="lng" style="display: none;"><?=$this->data['lng']?></div>
...
<div id="status" style="display: none;"><?=$this->data['status']?></div>
