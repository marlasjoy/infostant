            ...
            <article>
                <div class="d-676x316">
                   ...
                   <div id="textx676x316x0"  class="portfolioItemInfo"></div>
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/676x316x0/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
                </div>
                <div class="d-220x160">
            ...
            <article class="quote">
                <div class="inner">
                    <div  class="d-820x50 data">
                        <p><div id="title" class="font title black"><?=$this->data['title']?></div></p>
                          <a  href="<?=homeinfo.'/popup3/'.$this->data['landingpage'].'/title/'.$this->data['shop']['shopurl']?>" class="ir edit text">Edit Text</a>
                    </div>
                    <div   class="d-820x70">
                        <p><div id="detail" class="font detail black"><?=$this->data['description']?></div></p>
