		...
		<section id="one" class="clearfix">
			<article>
				<div class="d-940x350">
                    ...
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/940x350x0/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
				</div>
				<div class="d-220x90">
		...
		<section id="two" class="clearfix">
			<article class="left">
				...
				<div class="d-220x160">
                    ...
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/220x160x4/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
				</div>
				<div class="d-220x160">
					<span class="label">220 X 160</span>
                    ...
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/220x160x5/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
				</div>
				<div class="d-220x160">
					<span class="label">220 X 160</span>
                    ...
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/220x160x6/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
				</div>
				<div class="d-220x160">
					<span class="label">220 X 160</span>
                    ...
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/220x160x7/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
				</div>
			</article>
