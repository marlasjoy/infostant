<?php include(fullpathtemp."/head.php"); ?> 
		<script  src="<?=homeinfo?>/js/shop/mylibs/jasmin_400.font.js"></script>
  		<script>Cufon.replace('#main h3', { fontFamily: 'jasmin', fontSize: '46px' });</script>
		<style>.cufon-loading #main h3 { visibility: hidden!important; }</style>
		
		<link rel="stylesheet" href="<?=homeinfo?>/css/shop/hospital/hospital.css" media="all" />
</head>
<body class="backend">
  	<header>
  	...
  	<div id="main" role="main">
		<section id="one" class="clearfix">
			<div class="d-940x360">
				<span class="label">940 X 360</span>
				<div id="940x360x0"></div>
                    
                    <div id="textx940x360x0"  class="portfolioItemInfo"></div>
                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/940x360x0/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
			</div>
			<div class="d-220x90">
						...
						<tr>
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x0/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x1/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x2/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x3/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
						...
						<tr>
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x4/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x5/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x6/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
							...
							<td>
								<div class="d-208x148">
                                    ...
                                    <a href="<?=homeinfo.'/popup/'.$this->data['landingpage'].'/208x148x7/'.$this->data['shop']['shopurl'].'/group1'?>" class="ir edit img">Edit Image</a>
								</div>
								<div class="d-220x38">
