...
<div class="top">
    <div class="container">
        <div id="webdir" style="display: none;">http://www.infostant.com</div>
        <div id="subdir" style="display: none;">infostant.com</div>
        <img src="/images/demo/index-th_top.png" border="0" usemap="#Map" >
        <map name="Map">
    ...
    <div class="container content">
        <form name="register-form"    method="post" id="dummy">
          ...
          <p>
            <label for="dummy1">ชื่อผู้ใช้</label>
            <input type="text" name="username" id="username" class="text">
            </p>
            
          <p>
            <label for="dummy1">รหัสผ่าน</label>
            <input type="password" name="password1" id="password1" class="text">
            </p>

            
          <p>
            <label for="dummy1">ยืนยันรหัสผ่าน</label>
            <input type="password" name="repassword" id="repassword" class="text">
            </p>
            
          <p>
            <label for="dummy1">อีเมล์</label>
...
<div class="footer">
    <div class="container">
        <img src="/images/demo/index-th_bottom.png" border="0" usemap="#Map2" >
        <map name="Map2">
